...
<html>
    ...
    <?php include "navbar.html"; ?>
        ...
        <div class="wrap">
		    <ul class="tabs">
		    	<li><a href="#tab1"><span class="fa fa-bookmark"></span><span class="tab-text">Reseñas</span></a></li>
		    	<li><a href="#tab2"><span class="fa fa-group"></span><span class="tab-text">Comunidades</span></a></li>
		    	<li><a href="#tab3"><span class="fa fa-briefcase"></span><span class="tab-text">Canciones</span></a></li>
		    </ul>
